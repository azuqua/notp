...
class VectorClock {
   ...
   *
   * @return {VectorClock} This instance.
   *
   */
  insert(node) {
   ...
   * @instance
   *
   * @param {VectorClock} vclock - Vector clock to merge this instance with.
   *
   * @return {VectorClock} This instance.
   *
   */
   ...
   * @instance
   *
   * @param {VectorClock} vclock - Vector clock to check if this instance descends from.
   *
   ...
   * @instance
   *
   * @param {VectorClock} vclock - Vector clock to check equality with.
   *
