...
class DLMServer extends GenServer {
   ...
   * @param {String} holder - ID of actor/request for this lock.
   ...
   *
   * @return {Object|Error} An object if successfully parsed/validate, otherwise an Error indicating the reason for failure.
   *
   */
