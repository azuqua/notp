...
class Connection extends EventEmitter {
   ...
   * @param {Node} node - Node this connection communicates with.
   *
   */
   ...
   * @instance
   *
   * @return {Node} Node this instance communicates with.
   *
   */
  node() {
    return this._node;
  ...
  send(event, data) {
    if (this._active === false) {
      throw new Error("Cannot write to inactive connection.");
    }
